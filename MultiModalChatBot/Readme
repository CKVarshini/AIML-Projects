...
Welcome to LangChain and  Streamlit AI Chat, a versatile multimodal chatbot powered by LangChain's language processing capabilities and
Streamlit's interactive interface.

Project Overview:
LangChain Streamlit AI Chat offers a seamless way to interact with AI models across various modalities, including text, audio, images, and PDF documents. 
Whether you want to transcribe audio, describe images, summarize PDFs, or engage in text-based conversations, this project as covered.
...
PDF Handler:
-Gemini API Integration: Utilize the Gemini API key for PDF processing, enabling users to upload PDF files, request summarization, and interactively query 
                         the content through text-based conversations.
-Flexible API Integration: Users can seamlessly switch between Gemini API and OpenAI API by replacing their security keys in .env file and updating 
                            configurations, ensuring flexibility and customization based on individual preferences.
...
->Activate the Virtual Environment:Activate the virtual environment. On Windows: ./chat_venv/Scripts/activate
...
MISTRAL MODEL VERSION : 
  1.mistral-7b-instruct-v0.1.Q3_K_M.gguf
  2.mistral-7b-instruct-v0.1.Q3_K_M.gguf

LLAVA MODEL VERSION :
  1.ggml-model-q4_k.gguf
  2.ggml-model-q5_k.gguf
  3.mmproj-model-f16.gguf
...
7.Access the Application:Once the application is running, open your web browser and navigate to the URL provided by Streamlit (usually http://localhost:8501). 
                         You should now be able to interact with the Multimodal AI Chat.


References: 
https://youtu.be/CUjO8b6_ZuM?si=I_e1mVJNAuL8T-4Y
https://youtu.be/uus5eLz6smA?si=pruQvnslBG8mENGX



Additional Notes:
For Windows users, if you encounter any issues during the installation or execution process, refer to the troubleshooting section in the project repository 
